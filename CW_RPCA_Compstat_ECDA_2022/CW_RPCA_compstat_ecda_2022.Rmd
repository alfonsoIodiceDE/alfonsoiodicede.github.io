...
`r Citet(bib = compstat22_bib, "LoiTak18")`  iPCA (a.k.a iterative PCA, \cite{Kie97})  and its regularized version (RPCA) proved to outperform other PCA-based approaches.
