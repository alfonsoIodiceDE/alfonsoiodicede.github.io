...
- missing completely at random mechanism (** MCAR **): $P({\bf w}_{ij}=1\mid {\bf x}^{m}_{i},{\bf x}^{o}_{i}) = P({\bf w}_{ij}=1)$

- missing at random mechanism (** MAR **): $P({\bf w}_{ij}=1\mid {\bf x}^{m}_{i},{\bf x}^{o}_{i}) = P({\bf w}_{ij}=1\mid{\bf x}^{o}_{i})$

- missing not at random mechanism (** MNAR **): $P({\bf w}_{ij}=1\mid {\bf x}^{m}_{i},{\bf x}^{o}_{i}) \neq P({\bf w}_{ij}=1\mid{\bf x}^{o}_{i})$
