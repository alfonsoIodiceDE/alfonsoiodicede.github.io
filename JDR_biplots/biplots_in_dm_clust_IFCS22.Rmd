...
---
class: animated fadeIn
### partitioning cluster analysis: K-means
...
---
class: animated fadeIn 
### The Palmer Penguins data set (not iris) CITATION
...
fkm_map = scores_fkm %>% ggplot(aes(d1,d2))+geom_point(aes(color=cluster, shape=cluster),alpha=.5)+
...
pca_map = scores_pca %>% ggplot(aes(d1,d2))+geom_point(aes(color=cluster, shape=cluster),alpha=.5)+
